            ...
            <div class="col-md-12 col-sm-6 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" novalidate="" action="{{ route('user.update', [$data->id]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="email" id="email" name="email" required="required"
                                        class="form-control col-md-7 col-xs-12" placeholder="{{ $data->email }}" disabled>
                                    @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
